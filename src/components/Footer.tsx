        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8">
          <div className="lg:col-span-2 space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold">Creator Realm</span>
            </div>
            <p className="text-gray-400 max-w-md">
              Connecting African talent with global opportunities. Build your career, grow your network, and succeed on your terms.
            </p>
