        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <h2 className="text-4xl lg:text-5xl font-bold leading-tight">
              Build Your<br />
              Network: <span className="text-yellow-400">Creator<br />
              Realm Community</span>
            </h2>
            <p className="text-blue-100 text-lg leading-relaxed">
              Connect with like-minded creators, share experiences, and grow together in our vibrant community of over 20,000 talented individuals.
            </p>
          ...
          <div className="relative">
            <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 space-y-8">
              <div className="text-center">
                <h3 className="text-xl font-semibold mb-4">JOIN OUR TECH FAMILY OF OVER</h3>
                <div className="text-6xl font-bold text-yellow-400 mb-2">20K+</div>
              ...
              <div className="space-y-4">
                <div className="bg-white/20 rounded-2xl p-6 hover:bg-white/30 transition-colors">
                  <h4 className="font-semibold text-lg mb-2">GRASSROOTS</h4>
